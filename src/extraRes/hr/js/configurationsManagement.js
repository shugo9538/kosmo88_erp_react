        ...
        .ready(
                function() {
                    ...
                    if (currLocation.split('/')[5] == 'configurations') {
                        ...
                        var columns = hrCodeColumns;
                        var ordering = hrCodeOrder;

                        var url = '/selectHRCode';
